...
cat("Creating age polynomial terms for logistic regression...\n")
...
logit_covars <- c("ind", "fresh", "soph", "uc", "csu", "age", "age_sq", "age_cu",
...
rm(logit_model_app, logit_model_cal)
if (exists("tableA3_output")) rm(tableA3_output)
if (exists("coef_table")) rm(coef_table)
gc()